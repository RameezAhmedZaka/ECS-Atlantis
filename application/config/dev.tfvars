...
vpc = {
  ...
  public_subnet_name          = ["k8s-public-subnet-1"]
  private_subnet_name         = ["k8s-private-subnet-1", "k8s-private-subnet-2", "k8s-private-subnet-3", "k8s-private-subnet-4"]
...
bastion = {
  ...
  bastion_name            = "k8s-bastion-host"
  bastion_role            = "bastion-k8s"
