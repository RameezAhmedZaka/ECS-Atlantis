    ...
    plan:
      steps:
        - run: |
            ...
            terraform plan -var-file=config/production.tfvars -lock-timeout=300s -out=$PLANFILE
    apply:
      steps:
        - run: |
            echo "Project: $PROJECT_NAME"
    ...
    plan:
      steps:
        - run: |
            ...
            terraform plan -var-file=config/stage.tfvars -lock-timeout=300s -out=$PLANFILE
    apply:
      steps:
        - run: |
            echo "Project: $PROJECT_NAME"
    ...
    plan:
      steps:
        - run: |
            ...
            terraform plan -var-file=config/helia.tfvars -lock-timeout=300s -out=$PLANFILE
    apply:
      steps:
        - run: |
            echo "Project: $PROJECT_NAME"
